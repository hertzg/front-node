    ...
    res.end(
        ...
        '<html>' +
            '<head>' +
                ...
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/ReceivedFileMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/ReceivedTextMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/SendingFileMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/SendingTextMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/SentFileMessage.css" />' +
            ...
            '<body>' +
                ...
                '<script type="text/javascript" src="js/WorkPage/ReceivedFiles.js"></script>' +
                '<script type="text/javascript" src="js/WorkPage/SentFiles.js"></script>' +
                ...
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/FeedFile.js"></script>' +
                ...
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/ReceivedFileMessage.js"></script>' +
                ...
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/SendingFileMessage.js"></script>' +
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/SendingTextMessage.js"></script>' +
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/SentFileMessage.js"></script>' +
