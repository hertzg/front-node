    ...
    res.end(
        ...
        '<html>' +
            '<head>' +
                ...
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/ReceivedMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/SendingMessage.css" />' +
                '<link rel="stylesheet" type="text/css" href="css/WorkPage/ChatPanel/SentMessage.css" />' +
            ...
            '<body>' +
                ...
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/ReceivedMessage.js"></script>' +
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/SendingMessage.js"></script>' +
                '<script type="text/javascript" src="js/WorkPage/ChatPanel/SentMessage.js"></script>' +
